"""
Capture 150 images of notebook
...
def capture_notebook_images():
    """
    Capture 150 images of notebook (1 image every 5 seconds)
    """
    ...
    print("\nStarting capture...")
    print("Move your notebook around for variety!")
    ...
    try:
        while captured_count < total_images:
            ...
            cv2.imshow('Notebook Capture - Press ESC to stop', frame)
            ...
            if elapsed_time >= expected_capture_time:
                ...
                filename = f"{output_dir}/notebook_{captured_count + 1:03d}_{timestamp}.jpg"
