"""
Capture 150 images of mobile phone
...
def capture_mobile_phone_images():
    """
    Capture 150 images of mobile phone (1 image every 5 seconds)
    """
    
    # Create output directory
    output_dir = "mobile_phone_images"
    os.makedirs(output_dir, exist_ok=True)
    
    print("="*50)
    print("Mobile Phone Image Capture Script")
    print("="*50)
    print(f"Output directory: {output_dir}")
    print("Will capture 150 images (1 image every 5 seconds)")
    print("Total time: 750 seconds (12.5 minutes)")
    print("\nINSTRUCTIONS:")
    print("1. Position your mobile phone in front of the webcam")
    print("2. Hold it steady and show different angles")
    print("3. Press ENTER when ready to start capturing")
    print("4. Move the phone around during capture for variety")
    print("="*50)
    ...
    print("\nStarting capture...")
    print("Move your mobile phone around for variety!")
    ...
    try:
        while captured_count < total_images:
            ...
            cv2.imshow('Mobile Phone Capture - Press ESC to stop', frame)
            ...
            if elapsed_time >= expected_capture_time:
                ...
                filename = f"{output_dir}/mobile_phone_{captured_count + 1:03d}_{timestamp}.jpg"
    ...
    if captured_count == total_images:
        print("✓ Successfully captured all 100 images!")
    else:
