"""
Capture 150 images of backpack
...
def capture_backpack_images():
    """
    Capture 150 images of backpack (1 image every 5 seconds)
    """
    ...
    print("\nStarting capture...")
    print("Move your backpack around for variety!")
    ...
    try:
        while captured_count < total_images:
            ...
            cv2.imshow('Backpack Capture - Press ESC to stop', frame)
            ...
            if elapsed_time >= expected_capture_time:
                ...
                filename = f"{output_dir}/backpack_{captured_count + 1:03d}_{timestamp}.jpg"
