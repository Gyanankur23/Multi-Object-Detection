...
def capture_person_images():
    """
    Capture 150 images of person (1 image every 5 seconds)
    """
    ...
    print("="*50)
    print("Person Image Capture Script")
    print("="*50)
    ...
    print("2. Move around, change poses, and show different angles")
    print("3. Press ENTER when ready to start capturing")
    print("4. Keep moving during capture for variety")
    print("="*50)
    ...
    print("\nStarting capture...")
    print("Move around, change poses, and show different angles!")
    ...
    try:
        while captured_count < total_images:
            ...
            cv2.imshow('Person Capture - Press ESC to stop', frame)
            ...
            if elapsed_time >= expected_capture_time:
                ...
                filename = f"{output_dir}/person_{captured_count + 1:03d}_{timestamp}.jpg"
